...
class TestForecastCombineStrategy(unittest.TestCase):
    def setUp(self):
        ...
        self.accuracy_1 = accCalculator.compute_accuracy_metrics(real_counts=real_counts, forecasts=forecasts_1)
        self.accuracy_2 = accCalculator.compute_accuracy_metrics(real_counts=real_counts, forecasts=forecasts_2)
